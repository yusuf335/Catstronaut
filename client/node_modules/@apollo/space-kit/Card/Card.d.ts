...
interface CardProps extends React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>, CardSectionProps {
    /**
 ...
 */
export declare const CardSeperator: React.FC<{
    /**
     * color theme for alert
     * @default "light"
     */
