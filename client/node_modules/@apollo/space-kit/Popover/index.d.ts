...
interface Props extends Pick<React.ComponentProps<typeof AbstractTooltip>, "children" | "content" | "disabled" | "fallbackPlacements" | "hideOnClick" | "matchTriggerWidth" | "maxWidth" | "onCreate" | "placement" | "popperOptions"> {
    className?: string;
