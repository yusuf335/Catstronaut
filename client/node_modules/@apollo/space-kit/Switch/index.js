...
var Switch = function (_a) {
  var className = _a.className,
      style = _a.style,
      _b = _a.color,
      color = _b === void 0 ? colors.colors.blue.base : _b,
      isFocusVisibleFromProps = _a.isFocusVisible,
      _c = _a.showTextualState,
      showTextualState = _c === void 0 ? true : _c,
      _d = _a.size,
      size = _d === void 0 ? "normal" : _d,
      propsTheme = _a.theme,
      props = _tslib.__rest(_a, ["className", "style", "color", "isFocusVisible", "showTextualState", "size", "theme"]);

  var state = toggle.useToggleState(props);
  var ref = React__default.useRef(null);
  var inputProps = _switch.useSwitch(props, state, ref).inputProps;

  var _e = focus.useFocusRing(props),
      isFocusVisibleFromFocusRing = _e.isFocusVisible,
      focusProps = _e.focusProps; // FYI: Hooks can't be called conditionally, so we must call the hook and then
  ...
  var isFocusVisible = !props.isDisabled && isFocusVisibleFromProps || isFocusVisibleFromFocusRing;
  ...
  return /*#__PURE__*/React__default.createElement(core.ClassNames, null, function (_a) {
    ...
    return /*#__PURE__*/React__default.createElement(Label.Label, {
      ...
      style: style
    }, /*#__PURE__*/React__default.createElement(visuallyHidden.VisuallyHidden, null, /*#__PURE__*/React__default.createElement("input", _tslib.__assign({}, inputProps, focusProps, {
      ref: ref
    }))), /*#__PURE__*/React__default.createElement("div", {
      className: css({
        flex: 1,
        marginRight: showTextualState ? 12 : size === "large" ? 30 : size === "normal" ? undefined : assertUnreachable.assertUnreachable(size)
      })
    }, props.children), showTextualState && /*#__PURE__*/React__default.createElement("div", {
      "aria-hidden": true,
      className: css({
        color: theme === "light" ? props.isDisabled ? undefined : state.isSelected ? undefined : colors.colors.grey.base : theme === "dark" ? props.isDisabled ? undefined : state.isSelected ? colors.colors.white : colors.colors.midnight.lighter : assertUnreachable.assertUnreachable(theme),
        fontWeight: state.isSelected ? 600 : 400,
        marginRight: 8
      })
    }, state.isSelected ? "ON" : "OFF"), /*#__PURE__*/React__default.createElement("div", {
      "aria-hidden": true,
      ...
      className: css({
        ...
        boxShadow: [isFocusVisible && "0 0 0 2px " + colors.colors.blue.lighter, !props.isDisabled && "inset 0 0 1px 0 rgba(18, 21, 26, 0.4)"] // The generic attached to the filter return type will indicate
