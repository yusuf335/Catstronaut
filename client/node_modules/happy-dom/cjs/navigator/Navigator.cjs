...
class Navigator {
    ...
    constructor(ownerWindow) {
        ...
        __classPrivateFieldSet(this, _Navigator_clipboard, new Clipboard_js_1.default(ownerWindow), "f");
        __classPrivateFieldSet(this, _Navigator_permissions, new Permissions_js_1.default(), "f");
    }
    /**
     ...
     */
    get userAgent() {
        return __classPrivateFieldGet(this, _Navigator_ownerWindow, "f").happyDOM.settings.navigator.userAgent;
    }
    /**
